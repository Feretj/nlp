...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    return (
	      React.createElement("div", {className: styles.loading}, 
	        ...
	        React.createElement("div", {className: styles.loader}, 
	          React.createElement("span", {className: styles.dot + ' ' + styles.dot1}), 
	          React.createElement("span", {className: styles.dot + ' ' + styles.dot2}), 
	          React.createElement("span", {className: styles.dot + ' ' + styles.dot3}), 
	          React.createElement("span", {className: styles.dot + ' ' + styles.dot4})
	        )
	      )
	    );
	  }
	...
	var Result = React.createClass({displayName: "Result",
	  render: function() {
	    let childs = this.props.data.map(function(book) {
	      return (
	        React.createElement("div", {key: book.name}, 
	        React.createElement("p", null, book.name), 
	        React.createElement("p", null, book.result)
	        )
	      );
	    });
	    return (
	      React.createElement("div", {className: styles.contentBox}, 
	...
	var File = React.createClass({displayName: "File",
	  ...
	  render: function() {
	    let error = React.createElement("span", null)
	    if (this.state.error) {
	      error = React.createElement("span", {className: styles.error}, "Форма заполнена неправильно, либо сервер недоступен")
	    }
	    return (
	      React.createElement("div", {className: styles.contentBox}, 
	        ...
	        React.createElement("input", {onChange: this.handleChange, multiple: true, type: "file"}), 
	...
	var Archive = React.createClass({displayName: "Archive",
	  getInitialState: function() {
	    return {files: {length: 0}, error: false};
	  },
	  componentDidMount: function() {
	    ...
	    return (
	      React.createElement("div", {className: styles.contentBox}, 
	        ...
	        React.createElement("ul", null, 
	          React.createElement("li", null, " gztar "), 
	          React.createElement("li", null, " bztar "), 
	          React.createElement("li", null, " xztar "), 
	          React.createElement("li", null, " tar "), 
	          React.createElement("li", null, " zip ")
	        ), 
	        React.createElement("input", {onChange: this.handleChange, type: "file"}), 
	        React.createElement("button", {onClick: this.handleSubmit}, "submit"), 
	        React.createElement("br", null), 
	        error
	      )
	...
	var App = React.createClass({displayName: "App",
	  ...
	  render: function() {
	    var tabs = {"File": {component: React.createElement(File, {error: this.state.error, onFormSubmit: this.handleFormSubmit, startLoading: function(e) {this.setState({loading: e, error: !e})}.bind(this)}), text: "Фаил"},
	                "Archive": {component: React.createElement(Archive, {error: this.state.error, onFormSubmit: this.handleFormSubmit, startLoading: function(e) {this.setState({loading: e, error: !e})}.bind(this)}), text: "Архив"},
	                "Link" :{component: React.createElement(Link, {error: this.state.error, onFormSubmit: this.handleFormSubmit, startLoading: function(e) {this.setState({loading: e, error: !e})}.bind(this)}), text: "По ссылке"}};
	    let content;
	    if (this.state.loading) {
	      content = React.createElement(Loading, null)
	    } else if (this.state.result) {
	      content = React.createElement(Result, {back: function() {this.setState({result: false, error: false})}.bind(this), data: this.state.data.data});
	    } else {
	      content = tabs[this.state.tab].component;
	    }
	    return (
	      React.createElement("div", {className: styles.app}, 
	        React.createElement(MenuBar, {tabs: tabs, tab: this.state.tab, result: this.state.result, onChangeTab: this.changeTab}), 
	...
	var MenuBar = React.createClass({displayName: "MenuBar",
	  ...
	  render: function() {
	    ...
	    for (tab in this.props.tabs) {
	      ...
	      menuItems.push(React.createElement("a", {className: classes, id: tab, 
	        key: tab, onClick: f}, this.props.tabs[tab].text));
	    }
	    return (
	      React.createElement("div", {className: styles.menuBar}, 
	        menuItems
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./node_modules/css-loader/index.js?modules&camelCase&localIdentName=[name]_[local]!./node_modules/sass-loader/index.js!./style.css", function() {
				var newContent = require("!!./node_modules/css-loader/index.js?modules&camelCase&localIdentName=[name]_[local]!./node_modules/sass-loader/index.js!./style.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".style_app {\n  height: 100vh; }\n\n.style_menu-bar {\n  font-size: 18px;\n  display: flex;\n  justify-content: center;\n  width: 100%;\n  height: 60px;\n  background-color: #0f4da8;\n  position: absolute; }\n\n.style_menu-button {\n  padding-top: 20px;\n  box-sizing: border-box;\n  text-align: center;\n  color: white;\n  display: block;\n  height: 60px;\n  width: 200px; }\n\n.style_menu-button-active {\n  background-color: #437dd4; }\n\n.style_content {\n  padding: 30px;\n  padding-top: 90px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100%;\n  box-sizing: border-box;\n  background-color: #edeced; }\n\n.style_content-box {\n  padding: 40px;\n  background-color: #6a94d4;\n  box-shadow: 3px 3px 20px rgba(0, 0, 0, 0.4);\n  box-sizing: border-box;\n  min-width: 70%;\n  min-height: 60%; }\n\n.style_loading {\n  padding: 40px;\n  background-color: #ffcb73;\n  box-shadow: 3px 3px 20px rgba(0, 0, 0, 0.4);\n  box-sizing: border-box;\n  min-width: 40%;\n  min-height: 30%;\n  max-width: 600px; }\n\n.style_error {\n  color: red;\n  font-size: 14px; }\n\nbody {\n  font: normal normal 20px fantasy;\n  margin: 0; }\n\n.style_loader {\n  padding-top: 20px;\n  box-sizing: border-box;\n  position: relative;\n  width: 90px;\n  height: 15px;\n  margin: 25px auto; }\n\n.style_dot {\n  display: inline-block;\n  width: 15px;\n  height: 15px;\n  border-radius: 7.5px;\n  background: #437dd4;\n  position: absolute; }\n\n.style_dot1 {\n  animation: style_animateDot1 1.5s linear infinite;\n  left: 25px;\n  background: #052f6d; }\n\n.style_dot2 {\n  animation: style_animateDot2 1.5s linear infinite;\n  animation-delay: 0.5s;\n  left: 50px; }\n\n.style_dot3 {\n  animation: style_animateDot3 1.5s linear infinite;\n  left: 25px; }\n\n.style_dot4 {\n  animation: style_animateDot4 1.5s linear infinite;\n  animation-delay: 0.5s;\n  left: 50px; }\n\n@keyframes style_animateDot1 {\n  0% {\n    transform: rotate(0deg) translateX(-25px); }\n  25% {\n    transform: rotate(180deg) translateX(-25px); }\n  75% {\n    transform: rotate(180deg) translateX(-25px); }\n  100% {\n    transform: rotate(360deg) translateX(-25px); } }\n\n@keyframes style_animateDot2 {\n  0% {\n    transform: rotate(0deg) translateX(-25px); }\n  25% {\n    transform: rotate(-180deg) translateX(-25px); }\n  75% {\n    transform: rotate(-180deg) translateX(-25px); }\n  100% {\n    transform: rotate(-360deg) translateX(-25px); } }\n\n@keyframes style_animateDot3 {\n  0% {\n    transform: rotate(0deg) translateX(25px); }\n  25% {\n    transform: rotate(180deg) translateX(25px); }\n  75% {\n    transform: rotate(180deg) translateX(25px); }\n  100% {\n    transform: rotate(360deg) translateX(25px); } }\n\n@keyframes style_animateDot4 {\n  0% {\n    transform: rotate(0deg) translateX(25px); }\n  25% {\n    transform: rotate(-180deg) translateX(25px); }\n  75% {\n    transform: rotate(-180deg) translateX(25px); }\n  100% {\n    transform: rotate(-360deg) translateX(25px); } }\n", ""]);

	// exports
	exports.locals = {
		"app": "style_app",
		"app": "style_app",
		"menu-bar": "style_menu-bar",
		"menuBar": "style_menu-bar",
		"menu-button": "style_menu-button",
		"menuButton": "style_menu-button",
		"menu-button-active": "style_menu-button-active",
		"menuButtonActive": "style_menu-button-active",
		"content": "style_content",
		"content": "style_content",
		"content-box": "style_content-box",
		"contentBox": "style_content-box",
		"loading": "style_loading",
		"loading": "style_loading",
		"error": "style_error",
		"error": "style_error",
		"loader": "style_loader",
		...
		"dot1": "style_dot1",
		"dot1": "style_dot1",
		"animateDot1": "style_animateDot1",
		"animateDot1": "style_animateDot1",
		"dot2": "style_dot2",
		"dot2": "style_dot2",
		"animateDot2": "style_animateDot2",
		"animateDot2": "style_animateDot2",
		"dot3": "style_dot3",
		"dot3": "style_dot3",
		"animateDot3": "style_animateDot3",
		"animateDot3": "style_animateDot3",
		"dot4": "style_dot4",
		"dot4": "style_dot4",
		"animateDot4": "style_animateDot4",
		"animateDot4": "style_animateDot4"
	};
